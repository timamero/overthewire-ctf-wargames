...
Navigate to http://natas0.natas.labs.overthewire.org in the browser. You are presented with a bare page containing a couple of items. One is an element with the message "You can find the password for the next level on this page". The other element is an image button that redirects you to another hacking challenge website.
